...
int main()
{
    Generate_Data();        // Generate the data first, if not already

    /*
    * Part (a). Process trade booking data from input/trades.txt
    * Generate two output files: output/positions.txt and output/risk.txt
    * 
